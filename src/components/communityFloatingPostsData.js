...
export const COMMUNITY_POSTS = [
  ...
  },
  {
    ...
    username: 'ريم',
    usernameEn: 'Reem',
    text: 'زرعنا 10 أشجار في الحديقة اليوم!',
    textEn: 'We planted 10 trees in the park today!',
    likes: 94,
    comments: 11,
    avatar: earthieAvatarUrl,
    icon: '🌳',
  ...
  {
    id: 'mobile-water-bottle',
    username: 'طارق',
    usernameEn: 'Tarek',
    text: 'تركنا البلاستيك واستخدمنا الزجاج!',
    textEn: 'Ditched plastic, switched to glass bottles!',
    likes: 67,
    comments: 8,
    avatar: earthieAvatarUrl,
    icon: '🍶',
    iconBg: '#74cbd5',
    position: { top: '43%', right: '4%' },
    rotation: 5,
    layer: 'back',
    packId: 1,
    density: 'mobile',
  ...
  {
    id: 'mobile-street-clean',
    username: 'سمر',
    usernameEn: 'Samar',
    text: 'نظفنا الشارع بالكامل. شعور رائع!',
    textEn: 'We cleaned the whole street. Amazing feeling!',
    likes: 83,
    comments: 10,
    avatar: earthieAvatarUrl,
    icon: '✨',
  ...
  },
  {
    ...
    username: 'يوسف',
    usernameEn: 'Youssef',
    text: 'شاركنا 5 نصائح بيئية مع جيراننا.',
    textEn: 'Shared 5 eco tips with our neighbors.',
    likes: 75,
    comments: 9,
    avatar: earthieAvatarUrl,
    icon: '💚',
